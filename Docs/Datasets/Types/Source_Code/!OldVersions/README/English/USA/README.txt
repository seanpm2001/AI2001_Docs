...
As of 2023, Monday, October 23rd, there are `315` source code datasets (containing support for 313/314 languages) with many more coming in the coming months. They include:
...
Total languages (2023, Monday, October 23rd) `314` / `??` (`???.??%`)
...
> This listing includes `162` out of `314` languages (`51.59%`) of the AI2001 linguistics toolchain, as of 2023, Saturday, October 21st. It is currently missing `152` languages. I will try to add more daily. It is a struggle, as there is no hard concept for programming language families, and my method is getting a bit recursive. <!-- When calculating these notes, the entries from today, along with the 1 blue checkmark, keeps throwing me off. !-->
...
The next day (2023, Saturday, September 16th) I am still not ready, as I am again struggling with my schedule, and I lacked the motivation as well. From 2023, Saturday, September 16th to 2023, Monday, October 23rd, I am still not ready yet.
...
- **File version:** `109 (2023, Monday, October 23rd at 11:50 pm PST)`
- **Line count (including blank lines and compiler line):** `1,750`
- **Word count:** `10,354`
- **Character count (including spaces):** `084,680`
- **Character count (excluding spaces):** `071,657`
- **Size (in bytes):** `085,979`
