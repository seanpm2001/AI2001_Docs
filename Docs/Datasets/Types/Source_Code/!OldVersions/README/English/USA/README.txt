...
As of 2023, Thursday, November 23rd, there are `376` source code datasets (containing support for 375/376 languages) with many more coming in the coming months. They include:
...
> This listing includes `162` out of `376` languages (`43.08%`) of the AI2001 linguistics toolchain, as of 2023, Thursday, November 23rd. It is currently missing `242` languages. I will try to add more daily. It is a struggle, as there is no hard concept for programming language families, and my method is getting a bit recursive. <!-- When calculating these notes, the entries from today, along with the 1 blue checkmark, keeps throwing me off. !-->
...
The next day (2023, Saturday, September 16th) I am still not ready, as I am again struggling with my schedule, and I lacked the motivation as well. From 2023, Saturday, September 16th to 2023, Thursday, November 23rd, I am still not ready yet. Progress has dropped by nearly 50% in this time, and it will take a lot of work to get it back to where it was percentage-wise.
...
- **File version:** `114 (2023, Thursday, November 23rd at 07:34 pm PST)`
- **Line count (including blank lines and compiler line):** `2,021`
- **Word count:** `012,297`
- **Character count (including spaces):** `098,735`
- **Character count (excluding spaces):** `084,199`
- **Size (in bytes):** `100,278`
